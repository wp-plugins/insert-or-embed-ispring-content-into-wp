...
<p><i>Please choose a .zip file that you published with the iSpring software | Maximum upload file size: <strong><?php echo $upload_size_unit; echo $sizes[$u]; ?></strong></i></p>
